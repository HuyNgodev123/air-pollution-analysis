...
import {
  ...
  CreditCard,
  X,
} from "lucide-react"; // Import icon mũi tên
...
const SEED_DATA = [
  {
    ...
    price: 38500000,
    image:
      "https://cdn.shopify.com/s/files/1/0677/4059/8571/files/Atem_X_hero.jpg?v=1763393048&width=1940&crop=center",
    description:
      "Kích thước: 68.8 x 64 x 25.4 cm. Phòng: Trung bình đến lớn, lên đến 156 m².",
  },
  {
    ...
    price: 8900000,
    image:
      "https://cdn.shopify.com/s/files/1/0677/4059/8571/files/Atem_Desk_hero.jpg?v=1763392590&width=1940&crop=center",
    description:
      "Kích thước: 33 x 33 x 8.5 cm. Phòng: Không gian nhỏ và riêng tư, lên đến 14 m².",
  },
  {
    ...
    price: 10900000,
    image:
      "https://cdn.shopify.com/s/files/1/0677/4059/8571/files/Atem_Car_hero.jpg?v=1763393015&width=1940&crop=center",
    description:
      "Kích thước: 30 x 30 x 8.5 cm. Trao đổi khí trong cabin: lên đến 20 lần mỗi giờ.",
  },
  {
    ...
    price: 28500000,
    image:
      "https://cdn.shopify.com/s/files/1/0677/4059/8571/files/HP_250_hero.jpg?v=1763392467&width=1940&crop=center",
    description:
      "Dòng XE mới nhất. Hiệu suất lọc vượt trội cho môi trường ô nhiễm nặng.",
  },
  {
    ...
    price: 24500000,
    image:
      "https://cdn.shopify.com/s/files/1/0677/4059/8571/files/HP_250_NE_hero.jpg?v=1763392538&width=1940&crop=center",
  ...
  },
  {
    ...
    price: 61884000,
    image:
      "https://cdn.shopify.com/s/files/1/0677/4059/8571/files/CG_XE_hero.jpg?v=1763392446&width=1940&crop=center",
  ...
  },
  {
    ...
    price: 18500000,
    image:
      "https://cdn.shopify.com/s/files/1/0677/4059/8571/files/HP_100_NE_hero.jpg?v=1763394197&width=1940&crop=center",
    description:
      "Kích thước: 61 x 38 x 41 cm. Phòng: Trung bình đến lớn, lên đến 98 m².",
  },
  {
    ...
    price: 1500000,
    image:
      "https://cdn.shopify.com/s/files/1/0677/4059/8571/files/GC_NE_hero.jpg?v=1763395682&width=1940&crop=center",
...
const ProductsPage = () => {
  ...
  // Lấy danh sách danh mục duy nhất từ sản phẩm để hiện trong menu
  ...
  const currentProducts = filteredProducts.slice(indexOfFirstItem, indexOfLastItem); // Cắt mảng sản phẩm
    ...
    <div className="products-page-container">
      ...
      <div className="products-header">
        ...
        <div className="admin-tools">
          {/* --- CHỈ ADMIN MỚI THẤY NÚT QUẢN LÝ DATA --- */}
          {user?.role === "admin" && (
            <>
              {products.length > 0 && (
                <button
          ...
          <div className="filter-wrapper" style={{ position: "relative" }}>
            <button
              className={`btn btn-filter ${showFilterMenu ? "active" : ""}`}
              onClick={() => setShowFilterMenu(!showFilterMenu)}
            >
              <Filter size={18} />
              <span>
                {selectedCategory === "Tất cả" ? "Bộ lọc" : selectedCategory}
              </span>
